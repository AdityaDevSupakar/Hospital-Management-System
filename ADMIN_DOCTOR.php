...
<head>
    ...
    <title>DOCTOR-MANIPULATION</title>
    <style>
    * {
        margin: 0;
        padding: 0;
    ...
    .up {
        max-width: 100vw;
        min-height: 5vh;
        background-image: url('Photos/Time-Table.gif');
        display: flex;
...
<body>
    ...
    <div class="middle">
        <h1 style="font-family:Georgia, 'Times New Roman';margin-left:195px;"><u>Welcome Admin The List Of Doctors Of
                Our
                Hospital</u></h1>
